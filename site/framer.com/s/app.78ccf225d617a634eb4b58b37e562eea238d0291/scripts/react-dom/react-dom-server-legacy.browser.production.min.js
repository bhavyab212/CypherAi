  ...
  (function (w, F) {
          ...
          if (null != f && "boolean" !== typeof f && "" !== f) {
            if (0 === d.indexOf("--")) {
              ...
              void 0 !== g
                ? (e = g)
                : ((g = r(
                    e.replace(kb, "-$1").toLowerCase().replace(lb, "-ms-")
                  )),
                  va.set(e, g),
                  (e = g));
              f =
    ...
    function ob(a, b, c, d, f) {
      switch (b) {
        ...
        case "html":
          return (
            0 === f.insertionMode && a.push("<!DOCTYPE html>"), aa(a, c, b, d)
          );
        default:
    ...
    function ya(a, b, c, d) {
      ...
      "" === b
        ? (a = d)
        : (d && a.push("\x3c!-- --\x3e"), a.push(r(b)), (a = !0));
      return a;
    }
    function da(a) {
      ...
      if ("object" === typeof a)
        switch (a.$$typeof) {
          ...
          case Ia:
            return (
              (b = a.displayName || null), null !== b ? b : da(a.type) || "Memo"
            );
          case ea:
            b = a._payload;
            a = a._init;
    ...
    function Xa(a, b, c, d, f) {
      ...
      if (null !== e && void 0 !== e) {
        ...
        if ("function" !== typeof c.getChildContext) d = g;
          ...
          c = c.getChildContext();
          for (var h in c)
            if (!(h in e)) throw Error(l(108, da(d) || "Unknown", h));
          d = G({}, g, c);
        }
        b.legacyContext = d;
        u(a, b, f);
    ...
    function ma(a, b, c) {
      ...
      try {
        ...
        if (
          ...
          b.context = e;
          O(e);
        } else throw ((b.blockedSegment.formatContext = d), (b.legacyContext = f), (b.context = e), O(e), m);
      }
    }
    function Ib(a) {
    ...
    function ab(a, b, c) {
      if (null === b) {
        ...
        0 === a.pendingRootTasks &&
          ((a.onShellError = I), (b = a.onShellReady), b());
      } else b.pendingTasks--, b.forceClientRender || (0 === b.pendingTasks ? (c.parentFlushed && 1 === c.status && W(b, c), b.parentFlushed && a.completedBoundaries.push(b), b.fallbackAbortableTasks.forEach(Ib, a), b.fallbackAbortableTasks.clear()) : c.parentFlushed && 1 === c.status && (W(b, c), 1 === b.completedSegments.length && b.parentFlushed && a.partialBoundaries.push(b)));
      a.allPendingTasks--;
