          ...
          if (ranges.length || !nest.overlay)
            this.inner.push(
              new InnerParse(
                ...
                nest.overlay
                  ? nest.overlay.map(
                      (r) => new Range(r.from - cursor.from, r.to - cursor.from)
                    )
                  : null,
                cursor.tree,
            ...
            if (ranges.length) {
              ...
              this.inner.splice(
                ...
                new InnerParse(
                  ...
                  overlay.ranges.map(
                    (r) =>
                      new Range(r.from - overlay.start, r.to - overlay.start)
                  ),
                  overlay.target,
                  ranges[0].from
                )
        ...
        if (mount && mount.parser == parser) {
          for (let i = this.fragI; i < this.fragments.length; i++) {
            ...
            if (frag.tree == this.curFrag.tree)
              result.push({ frag, pos: pos2.from - frag.offset, mount });
          }
        }
      }
    }
...
export const __FramerMetadata__ = {
  exports: {
    ...
    NodeProp: { type: "variable", annotations: { framerContractVersion: "1" } },
    IterMode: { type: "variable", annotations: { framerContractVersion: "1" } },
    NodeSet: { type: "variable", annotations: { framerContractVersion: "1" } },
    NodeType: { type: "variable", annotations: { framerContractVersion: "1" } },
    TreeBuffer: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
    Tree: { type: "variable", annotations: { framerContractVersion: "1" } },
    NodeWeakMap: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
...
//# sourceMappingURL=./lezer_common.map
