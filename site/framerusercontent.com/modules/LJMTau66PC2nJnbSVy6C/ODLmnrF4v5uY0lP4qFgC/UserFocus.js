...
var UserFocus_default = (React) => {
  if (!Component) {
    ...
    const UserFocus = React.forwardRef((props, ref) =>
      /* @__PURE__ */ React.createElement(
        "g",
        { ref, ...props },
...
export { __FramerMetadata__, UserFocus_default as default };
