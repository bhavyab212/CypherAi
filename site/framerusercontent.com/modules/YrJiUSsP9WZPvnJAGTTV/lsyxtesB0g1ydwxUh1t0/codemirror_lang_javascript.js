...
import { parser } from "/framerusercontent.com/modules/2B1yVjX9TEUbuHzHLnih/slPptusM3aarmySLiAK2/lezer_javascript.js";
import {
  syntaxTree,
  LRLanguage,
  indentNodeProp,
...
function isEndTag(node) {
  return (
    node && (node.name == "JSXEndTag" || node.name == "JSXSelfCloseEndTag")
  );
}
var android =
  ...
  (view, from, to, text) => {
    ...
    let changes = state.changeByRange((range) => {
      ...
      if (around.name == "JSXAttributeValue" && around.to > head);
        ...
        if (
          empty.from == head - 1 &&
          ((_a = base.lastChild) === null || _a === void 0
            ? void 0
            : _a.name) != "JSXEndTag" &&
          (name = elementName(
            state.doc,
            base === null || base === void 0 ? void 0 : base.firstChild,
            head
          ))
        ) {
          let insert = `/${name}>`;
...
export const __FramerMetadata__ = {
  exports: {
    ...
    snippets: { type: "variable", annotations: { framerContractVersion: "1" } },
    javascriptLanguage: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
    ...
    esLint: { type: "function", annotations: { framerContractVersion: "1" } },
    typescriptLanguage: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
