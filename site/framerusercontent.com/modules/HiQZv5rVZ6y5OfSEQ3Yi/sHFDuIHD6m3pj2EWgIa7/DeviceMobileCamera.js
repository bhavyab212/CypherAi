let Component;
var DeviceMobileCamera_default = (React) => {
  if (!Component) {
    ...
    const DeviceMobileCamera = React.forwardRef((props, ref) =>
      /* @__PURE__ */ React.createElement(
        "g",
        { ref, ...props },
...
export { __FramerMetadata__, DeviceMobileCamera_default as default };
