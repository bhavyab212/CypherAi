...
var Stack = class {
  /// @internal
  toString() {
    return `[${this.stack.filter((_, i) => i % 3 == 0).concat(this.state)}]@${
      this.pos
        ...
        console.log(
          base +
            ...
            ` (via ${
              (action & 65536) == 0
                ? "shift"
                : `reduce of ${parser.getName(action & 65535)}`
...
export const __FramerMetadata__ = {
  exports: {
    ...
    LRParser: { type: "variable", annotations: { framerContractVersion: "1" } },
    Stack: { type: "variable", annotations: { framerContractVersion: "1" } },
    ContextTracker: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
