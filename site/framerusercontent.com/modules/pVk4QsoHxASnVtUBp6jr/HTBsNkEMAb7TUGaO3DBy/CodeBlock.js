...
import {
  ...
  SandpackLayout,
  SandpackProvider,
} from "/framerusercontent.com/modules/SWAtenub3goqbKHfvwGg/1dCB1yMDMTFvIuREJ6ud/codesandbox_sandpack_react.js";
import { addPropertyControls, ControlType, withCSS } from "framer";
import { Browser } from "/framerusercontent.com/modules/wOI0XDWuPNeaYuatKp4b/ezOdeUpHBrE7fwL9evTL/browser.js";
import { supportedLanguages } from "/framerusercontent.com/modules/19BkzxjVBT3VP0Ykl3DY/3DPoanIA3vfPHW40mbKX/types.js";
import { useLanguageAsync } from "/framerusercontent.com/modules/DyzTKdNCsRH8nvz08sNT/1bZkTPmppsxNhQB2wWTJ/useLanguageAsync.js";
import {
  getFileExtensions,
  titleCase,
  useBorder,
  ...
  usePadding,
  useRadius,
} from "/framerusercontent.com/modules/IdMJ4CymCWCh4cOBkZlb/eelWnWuz7D3MwsDAYYYK/utils.js";
import {
  darkThemeVariables,
  ...
  lightThemeVariables,
  themeKeys,
} from "/framerusercontent.com/modules/HdJmYu90NFzknVhsFw9C/pDjf2L2dKqeDsbErAmV0/theming.js";
    ...
    children: [
      /*#__PURE__*/ _jsx(SandpackProvider, {
        ...
        children: /*#__PURE__*/ _jsx(SandpackLayout, {
          style: {
            height: "100%", // make sure the codeblock doesnt grow beyond
            // the height of its contents
            "--sp-layout-height": "100%", // set the variables for padding we use in the overrides
            "--cb-padding": `${padding}`,
            ...borderStyles, // match editor background color to make borders visually blend with the editor:
...
export const __FramerMetadata__ = {
  exports: {
    default: {
      ...
      slots: [],
      annotations: {
        framerComponentPresetProps:
          "borderRadius, border, font, themeMode, theme, lightTheme, darkTheme, background, padding",
        framerDisableUnlink: "*",
        framerSupportedLayoutHeight: "any",
        framerSupportedLayoutWidth: "fixed",
