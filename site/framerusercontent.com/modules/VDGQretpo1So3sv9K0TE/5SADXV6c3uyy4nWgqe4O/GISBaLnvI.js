...
const Component = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  const href = useSVGTemplate("2682472775", svg);
  return /*#__PURE__*/ _jsx(SVG, {
    ...restProps,
    className: cx("framer-NxcZh", className),
    layoutId: layoutId,
    ref: ref,
    role: "presentation",
    style: {
...
const css = [
  `.framer-NxcZh { -webkit-mask: ${mask}; aspect-ratio: 1; display: block; mask: ${mask}; width: 24px; }`,
];
/**
 ...
 * @framerVector {"name":"Number Circle One","color":{"type":"variable","value":"21h8s6"},"set":{"localId":"vectorSet/NGVKdicsm","id":"NGVKdicsm","moduleId":"omX0gWFPqDwhaiWwf6ab"}}
 * @framerDisableUnlink true
 */ const Icon = withCSS(Component, css, "framer-NxcZh");
Icon.displayName = "Number Circle One";
export default Icon;
...
export const __FramerMetadata__ = {
  exports: {
    default: {
      ...
      annotations: {
        framerVector:
          '{"name":"Number Circle One","color":{"type":"variable","value":"21h8s6"},"set":{"localId":"vectorSet/NGVKdicsm","id":"NGVKdicsm","moduleId":"omX0gWFPqDwhaiWwf6ab"}}',
        framerSupportedLayoutHeight: "any-prefer-fixed",
        framerIntrinsicWidth: "24",
        framerDisableUnlink: "true",
        framerImmutableVariables: "true",
