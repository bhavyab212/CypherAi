...
import {
  parser,
  configureNesting,
} from "/framerusercontent.com/modules/GrkjcC7Ol5LkBvrp44De/6z7UMqAq3iGnlCYUf9GL/lezer_html.js";
import {
  cssLanguage,
  css,
} from "/framerusercontent.com/modules/Gg5hLFaRxQ2EaXSWb101/NVSL3b7ItCp8LKQ0X8xX/codemirror_lang_css.js";
import {
  typescriptLanguage,
  jsxLanguage,
  tsxLanguage,
  javascriptLanguage,
  javascript,
} from "/framerusercontent.com/modules/YrJiUSsP9WZPvnJAGTTV/lsyxtesB0g1ydwxUh1t0/codemirror_lang_javascript.js";
import { EditorView } from "/framerusercontent.com/modules/wKCR2JyUW8wZdYweJrou/QTymt9nRixOIrUSZrfIJ/codemirror_view.js";
import { EditorSelection } from "/framerusercontent.com/modules/wFkXxZqfKOPeEQtsYrsa/772bfdCR3vXAPJJXnNsc/codemirror_state.js";
import {
  syntaxTree,
  LRLanguage,
  indentNodeProp,
...
function allowedChildren(doc, tree, schema) {
  ...
  return (
    (parentInfo === null || parentInfo === void 0
      ? void 0
      : parentInfo.children) || schema.allTags
  );
}
...
function completeAttrValue(state, schema, tree, from, to) {
  var _a;
  let nameNode =
    (_a = tree.parent) === null || _a === void 0
      ? void 0
      : _a.getChild("AttributeName");
  let options = [],
    token = void 0;
  if (nameNode) {
    ...
    if (!attrs) {
      let elt = findParentElement(tree),
        info = elt ? schema.tags[elementName(state.doc, elt)] : null;
      attrs =
        (info === null || info === void 0 ? void 0 : info.attrs) &&
        info.attrs[attrName];
    }
    if (attrs) {
...
var defaultAttrs = /* @__PURE__ */ [
  ...
  /* @__PURE__ */ eventAttributes.map((name) => ({
    name,
    parser: javascriptLanguage.parser,
  }))
);
...
export const __FramerMetadata__ = {
  exports: {
    ...
    html: { type: "function", annotations: { framerContractVersion: "1" } },
