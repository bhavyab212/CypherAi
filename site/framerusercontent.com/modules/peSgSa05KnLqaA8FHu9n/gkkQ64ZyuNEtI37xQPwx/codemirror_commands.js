...
import { NodeProp } from "/framerusercontent.com/modules/CO9ruPlVDRTCLVInyri7/ye873rtFsAyZVFu9x2He/lezer_common.js";
...
var HistEvent = class {
  ...
  toJSON() {
    ...
    return {
      changes:
        (_a = this.changes) === null || _a === void 0 ? void 0 : _a.toJSON(),
      mapped:
...
var selectMatchingBracket = ({ state, dispatch }) =>
...
var transposeChars = ({ state, dispatch }) => {
  ...
  if (changes.changes.empty) return false;
  dispatch(
    state.update(changes, { scrollIntoView: true, userEvent: "move.character" })
  );
  return true;
};
...
function copyLine(state, dispatch, forward) {
  ...
  dispatch(
    state.update({ changes, scrollIntoView: true, userEvent: "input.copyline" })
  );
  return true;
}
...
export const __FramerMetadata__ = {
  exports: {
    undo: { type: "variable", annotations: { framerContractVersion: "1" } },
    selectLineUp: {
      type: "variable",
    ...
    redo: { type: "variable", annotations: { framerContractVersion: "1" } },
    indentSelection: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
    ...
    history: { type: "function", annotations: { framerContractVersion: "1" } },
    insertBlankLine: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
