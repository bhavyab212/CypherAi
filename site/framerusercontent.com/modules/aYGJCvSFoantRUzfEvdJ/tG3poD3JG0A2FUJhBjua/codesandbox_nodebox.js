  ...
  return function debug3(message, ...data) {
    if (FLAG === "true") {
      ...
      console.debug(
        `${
          COLOR_SCOPE[scope]
        }${scope}:${direction()}${DEFAULT}:${cleanMessage}`,
        ...data
      );
    }
  };
...
var MessageReceiver = class {
  ...
  constructor() {
    _define_property(this, "emitter", void 0);
    _define_property(this, "senderPort", null);
...
export const __FramerMetadata__ = {
  exports: {
    Nodebox: { type: "variable", annotations: { framerContractVersion: "1" } },
    PREVIEW_LOADED_MESSAGE_TYPE: {
      type: "variable",
...
//# sourceMappingURL=./codesandbox_nodebox.map
