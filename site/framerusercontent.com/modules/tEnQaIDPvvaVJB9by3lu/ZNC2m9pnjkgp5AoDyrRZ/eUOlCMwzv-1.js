...
import { ComponentPresetsConsumer as r, Link as t, motion as n } from "framer"; // ../../library/src/router/lazy.tsx
        ...
        switch (i[0]) {
          ...
          case 3 /* Module */: {
            let [, t, n] = i,
              a = o[t];
            return (
              m(a, "Module not found"),
              u(a) && a.preload(),
              /*#__PURE__*/ e(r, {
                componentIdentifier: t,
                children: (r) => /*#__PURE__*/ e(a, { ...r, ...n }),
              })
            );
          }
          case 4 /* Tag */: {
...
export { s as RichTextJsonType, f as getRichTextJsonResolver };
