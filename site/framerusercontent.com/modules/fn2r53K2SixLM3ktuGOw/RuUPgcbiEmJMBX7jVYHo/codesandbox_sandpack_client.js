...
function createPackageJSON(dependencies, devDependencies, entry) {
  ...
  return JSON.stringify(
    { name: "sandpack-project", main: entry, dependencies, devDependencies },
    null,
    2
  );
}
  ...
  if (packageJsonFile) {
    ...
    if (dependencies) {
      packageJsonContent.dependencies = __assign(
        __assign(
          {},
          (_a2 = packageJsonContent.dependencies) !== null && _a2 !== void 0
            ? _a2
            : {}
        ),
    ...
    if (devDependencies) {
      packageJsonContent.devDependencies = __assign(
        __assign(
          {},
          (_b = packageJsonContent.devDependencies) !== null && _b !== void 0
            ? _b
            : {}
        ),
...
} from "/framerusercontent.com/modules/aYGJCvSFoantRUzfEvdJ/tG3poD3JG0A2FUJhBjua/codesandbox_nodebox.js";
  ...
  "../../node_modules/@codesandbox/sandpack-client/dist/clients/node/index.mjs"() {
    ...
    SandpackNode = /** @class */ (function (_super) {
      ...
      function SandpackNode2(selector, sandboxInfo, options) {
        ...
        var _this =
          _super.call(
            ...
            selector,
            sandboxInfo,
            __assign(__assign({}, options), { bundlerURL: options.bundlerURL })
          ) || this;
          ...
          return __generator(this, function (_b) {
            switch (_b.label) {
                        ...
                        data: __assign(__assign({}, data), {
                          command: [
                            ...
                            _a3 === void 0
                              ? void 0
                              : _a3[0],
                            (_b2 = _this.emulatorCommand) === null ||
                            _b2 === void 0
                              ? void 0
                              : _b2[1].join(" "),
                          ].join(" "),
              ...
              case 2:
                ...
                return [
                  4,
                  (_a2 = this.emulatorShellProcess).runCommand.apply(
                    _a2,
                    this.emulatorCommand
                  ),
                ];
            ...
            switch (_b.label) {
              ...
              case 1:
                ...
                this.iframePreviewUrl =
                  url +
                  ((_a2 = this.options.startRoute) !== null && _a2 !== void 0
                    ? _a2
                    : "");
                return [2];
            }
        ...
        return __awaiter(this, void 0, void 0, function () {
          return __generator(this, function (_b) {
            switch (_b.label) {
              ...
              case 1:
                _b.sent();
                (_a2 = this.iframe) === null || _a2 === void 0
                  ? void 0
      ...
      SandpackNode2.prototype.updateSandbox = function (setup) {
        ...
        if (
          ((_a2 = this.emulatorShellProcess) === null || _a2 === void 0
            ? void 0
            : _a2.state) === "running"
        ) {
            ...
            switch (_d.label) {
              ...
              case 4:
                (_b =
                  (_a2 = this.iframe) === null || _a2 === void 0
                    ? void 0
                    : _a2.contentWindow) === null || _b === void 0
                  ? void 0
                  : _b.postMessage(message, "*");
                return [3, 8];
              case 5:
    ...
    var PreviewController2 = class {
      ...
      async _initPreview() {
        ...
        return new Promise((resolve) => {
          ...
          iframe.onload = () => {
            const initMsg = { $channel: CHANNEL_NAME2, $type: "preview/init" };
      ...
      function SandpackStatic2(selector, sandboxSetup, options) {
        ...
        _this.previewController =
          new import_static_browser_server.PreviewController({
            baseUrl:
              (_a2 = options.bundlerURL) !== null && _a2 !== void 0
                ? _a2
                : "https://preview.sandpack-static-server.codesandbox.io", // filepath is always normalized to start with / and not end with a slash
      ...
      SandpackStatic2.prototype.dispatch = function (message) {
        ...
        switch (message.type) {
          case "compile":
            ...
            break;
          default:
            (_a2 = this.iframe.contentWindow) === null || _a2 === void 0
              ? void 0
    ...
    SandpackRuntime = /** @class */ (function (_super) {
      ...
      SandpackRuntime2.prototype.createBundlerURL = function () {
        ...
        if (this.options.experimental_enableServiceWorker) {
          ...
          bundlerURL = bundlerURL.replace(
            SUFFIX_PLACEHOLDER,
            "-".concat(
              (_a2 = this.options.experimental_stableServiceWorkerId) !==
                null && _a2 !== void 0
                ? _a2
                : suffixes.join("-")
            )
      ...
      SandpackRuntime2.prototype.serviceWorkerHandshake = function () {
        ...
        var sendMessage = function () {
          var initMsg = { $channel: CHANNEL_NAME, $type: "preview/init" };
          iframeContentWindow.postMessage(initMsg, "*", [channel.port2]);
      ...
      SandpackRuntime2.prototype.updateSandbox = function (
        ...
        var modules = Object.keys(files).reduce(function (prev, next) {
          ...
          return __assign(
            __assign({}, prev),
            ((_a3 = {}),
            (_a3[next] = { code: files[next].code, path: next }),
            _a3)
          );
        }, {});
        ...
        try {
          ...
          console.error(
            createError("could not parse package.json file: " + e.message)
          );
        }
        var normalizedModules = Object.keys(files).reduce(function (
          ...
          return __assign(
            __assign({}, prev),
            ((_a3 = {}),
            (_a3[next] = { content: files[next].code, path: next }),
            _a3)
          );
        },
        {});
        this.dispatch(
          __assign(__assign({}, this.options), {
            ...
            showOpenInCodeSandbox:
              (_a2 = this.options.showOpenInCodeSandbox) !== null &&
              _a2 !== void 0
                ? _a2
                : true,
            showErrorScreen:
              (_b = this.options.showErrorScreen) !== null && _b !== void 0
                ? _b
                : true,
            showLoadingScreen:
              (_c = this.options.showLoadingScreen) !== null && _c !== void 0
                ? _c
                : false,
...
//# sourceMappingURL=./codesandbox_sandpack_client.map
