...
import {
  ...
  RangeSetBuilder,
  countColumn,
} from "/framerusercontent.com/modules/wFkXxZqfKOPeEQtsYrsa/772bfdCR3vXAPJJXnNsc/codemirror_state.js"; // ../../node_modules/style-mod/src/style-mod.js
var C = "ͼ";
      ...
      if (childView) {
        ...
        if (contains(child, node))
          return (
            pos +
            (hasComp
              ? posFromDOMInCompositionTree(node, offset, childView, text, dLen)
...
function posFromDOMInOpaqueNode(node, offset, target) {
  if (target.nodeType == 3) {
    ...
    let pos = 0;
    for (
      let child = target.firstChild, i = 0;
      ;
...
function updateAttrs(dom, prev, attrs) {
  ...
  if (prev) {
    for (let name in prev)
      if (!(attrs && name in attrs)) dom.removeAttribute((changed = name));
  }
  if (attrs) {
...
var InputState = class {
  ...
  ensureHandlers(view, plugins) {
    ...
    for (let plugin2 of plugins)
      if (
        (handlers2 =
          (_a = plugin2.update(view).spec) === null || _a === void 0
            ? void 0
            : _a.domEventHandlers)
      ) {
...
var HeightMapGap = class extends HeightMap {
  ...
  blockAt(height, oracle, top2, offset) {
    ...
    if (oracle.lineWrapping) {
      let guess =
        offset +
        Math.round(
          Math.max(0, Math.min(1, (height - top2) / this.height)) * this.length
        );
      ...
      let line = Math.max(
        0,
        Math.min(lastLine - firstLine, Math.floor((height - top2) / perLine))
      );
  ...
  lineAt(value, type, oracle, top2, offset) {
    ...
    let lineTop =
      top2 + perLine * linesAbove + perChar * (line.from - offset - linesAbove);
    return new BlockInfo(
      line.from,
      line.length,
...
var ViewState = class {
  ...
  viewportIsAppropriate({ from, to }, bias = 0) {
    ...
    let { visibleTop, visibleBottom } = this;
    return (
      (from == 0 || top2 <= visibleTop - Math.max(10, Math.min(-bias, 250))) &&
  ...
  delayAndroidKey(key, keyCode) {
    ...
    if (!this.delayedAndroidKey || key == "Enter")
      this.delayedAndroidKey = {
        key,
        keyCode, // Only run the key handler when no changes are detected if
...
var EditorView = class {
  ...
  */ static findFromDOM(dom) {
    ...
    return (
      ((_a = cView === null || cView === void 0 ? void 0 : cView.rootView) ===
        null || _a === void 0
        ? void 0
        : _a.view) || null
    );
      ...
      for (let i = 0; i < this.manager.tooltips.length; i++) {
        ...
        let left =
          size.width > space.right - space.left
            ...
            : Math.max(
                space.left,
                pos.left - width + (arrow ? 14 : 0) - offset.x
              );
        ...
        if (arrow)
          arrow.style.left = `${
            pos.left + (ltr ? offset.x : -offset.x) - (left + 14 - 7)
          }px`;
        if (tView.overlap !== true)
  ...
  (state) => {
    ...
    return {
      pos: Math.min(...tooltips2.map((t) => t.pos)),
        ...
        ...tooltips2.filter((t) => t.end != null).map((t) => t.end)
      ),
  ...
  mousemove(event) {
    ...
    if ((tooltip && !isInTooltip(this.lastMove.target)) || this.pending) {
      let { pos } = tooltip || this.pending,
          ...
          (_a =
            tooltip === null || tooltip === void 0 ? void 0 : tooltip.end) !==
            null && _a !== void 0
            ? _a
            : pos;
      if (
...
export const __FramerMetadata__ = {
  exports: {
    keymap: { type: "variable", annotations: { framerContractVersion: "1" } },
    layer: { type: "function", annotations: { framerContractVersion: "1" } },
    hasHoverTooltips: {
      type: "function",
    ...
    BidiSpan: { type: "variable", annotations: { framerContractVersion: "1" } },
    Decoration: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
    ...
    tooltips: { type: "function", annotations: { framerContractVersion: "1" } },
    __test: { type: "variable", annotations: { framerContractVersion: "1" } },
    crosshairCursor: {
      type: "function",
      annotations: { framerContractVersion: "1" },
    },
    panels: { type: "function", annotations: { framerContractVersion: "1" } },
    showPanel: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
    ...
    gutter: { type: "function", annotations: { framerContractVersion: "1" } },
    GutterMarker: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
    ...
    gutters: { type: "function", annotations: { framerContractVersion: "1" } },
    highlightTrailingWhitespace: {
      type: "function",
      annotations: { framerContractVersion: "1" },
    },
    ...
    getPanel: { type: "function", annotations: { framerContractVersion: "1" } },
    runScopeHandlers: {
      type: "function",
      annotations: { framerContractVersion: "1" },
    },
...
//# sourceMappingURL=./codemirror_view.map
