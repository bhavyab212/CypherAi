...
import { parser } from "/framerusercontent.com/modules/baxvQBtmpZ5GFXZ1GP2Q/H0MWM2nOs0wKqaypim0h/lezer_css.js";
import {
  syntaxTree,
  LRLanguage,
  indentNodeProp,
  ...
  if (node.to - node.from > 4096) {
    ...
    node.cursor().iterate((node2) => {
      ...
      if (
        ...
        ((_a = node2.node.nextSibling) === null || _a === void 0
          ? void 0
          : _a.name) == ":"
      ) {
...
var cssCompletionSource = /* @__PURE__ */ defineCSSCompletionSource(
...
export const __FramerMetadata__ = {
  exports: {
    css: { type: "function", annotations: { framerContractVersion: "1" } },
    cssCompletionSource: {
      type: "variable",
