  ...
  dynamicSlot(addresses) {
    ...
    for (let dep of this.dependencies) {
      if (dep == "doc") depDoc = true;
        ...
        (((_a = addresses[dep.id]) !== null && _a !== void 0 ? _a : 1) & 1) ==
        0
      )
...
var Chunk = class {
  ...
  between(offset, from, to, f) {
    for (
      ...
      if (
        f(this.from[i] + offset, this.to[i] + offset, this.value[i]) === false
      )
        return false;
  }
  map(offset, changes) {
...
export const __FramerMetadata__ = {
  exports: {
    Prec: { type: "variable", annotations: { framerContractVersion: "1" } },
    Line: { type: "variable", annotations: { framerContractVersion: "1" } },
    RangeSetBuilder: {
      type: "variable",
    ...
    MapMode: { type: "variable", annotations: { framerContractVersion: "1" } },
    ChangeDesc: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
    ...
    Text: { type: "variable", annotations: { framerContractVersion: "1" } },
    StateField: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
    ...
    RangeSet: { type: "variable", annotations: { framerContractVersion: "1" } },
    findClusterBreak: {
      type: "function",
      annotations: { framerContractVersion: "1" },
    },
    ...
    Range: { type: "variable", annotations: { framerContractVersion: "1" } },
    Facet: { type: "variable", annotations: { framerContractVersion: "1" } },
    RangeValue: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
...
//# sourceMappingURL=./codemirror_state.map
