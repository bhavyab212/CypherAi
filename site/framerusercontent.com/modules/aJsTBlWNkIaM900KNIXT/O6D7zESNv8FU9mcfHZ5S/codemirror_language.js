...
import {
  ...
  NodeType,
  NodeSet,
} from "/framerusercontent.com/modules/CO9ruPlVDRTCLVInyri7/ye873rtFsAyZVFu9x2He/lezer_common.js";
import {
  StateEffect,
  StateField,
  Facet,
...
import {
  ...
  highlightTree,
  styleTags,
} from "/framerusercontent.com/modules/rOWwbZHN39cczduPnzmw/seDszB8oQDQQyH7PIqkK/lezer_highlight.js"; // ../../node_modules/style-mod/src/style-mod.js
var C = "ͼ";
    ...
    this.extension = [
      ...
      EditorState.languageData.of((state, pos, side) => {
        let top2 = topNodeAt(state, pos, side),
          data2 = top2.type.prop(languageDataProp);
        if (!data2) return [];
        let base = state.facet(data2),
...
function ensureSyntaxTree(state, upto, timeout = 50) {
  var _a2;
  let parse =
    (_a2 = state.field(Language.state, false)) === null || _a2 === void 0
      ? void 0
      : _a2.context;
...
function syntaxParserRunning(view) {
  var _a2;
  return (
    ((_a2 = view.plugin(parseWorker)) === null || _a2 === void 0
      ? void 0
      : _a2.isWorking()) || false
  );
}
...
function findFold(state, from, to) {
  var _a2;
  let found = null;
  (_a2 = state.field(foldState, false)) === null || _a2 === void 0
    ? void 0
    : _a2.between(from, to, (from2, to2) => {
        if (!found || found.from > from2) found = { from: from2, to: to2 };
      });
  return found;
}
...
var defaultConfig = { placeholderDOM: null, placeholderText: "…" };
  ...
  return [
    ...
    gutter({
      ...
      markers(view) {
        var _a2;
        return (
          ((_a2 = view.plugin(markers)) === null || _a2 === void 0
            ? void 0
            : _a2.markers) || RangeSet.empty
        );
      },
      initialSpacer() {
...
export const __FramerMetadata__ = {
  exports: {
    ...
    foldCode: { type: "variable", annotations: { framerContractVersion: "1" } },
    foldable: { type: "function", annotations: { framerContractVersion: "1" } },
    toggleFold: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
    ...
    DocInput: { type: "variable", annotations: { framerContractVersion: "1" } },
    Language: { type: "variable", annotations: { framerContractVersion: "1" } },
    getIndentation: {
      type: "function",
      annotations: { framerContractVersion: "1" },
    },
    ...
    foldAll: { type: "variable", annotations: { framerContractVersion: "1" } },
    foldNodeProp: {
      type: "variable",
      annotations: { framerContractVersion: "1" },
    },
